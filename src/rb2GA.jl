...
#      rebalStep: Iteration interval to reset population back to cluster arrangement
#
function rb2GA(objfun::Function,
               N::Int,
               ...
               rebalancer::Function = (x->x),
               iterations::Int = 10*N,
               rebalStep::Int = div(iterations,5),
               tol = 0.0,
               tolIter = 10,
